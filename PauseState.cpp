...
void PauseState::enter()
{
	...
	OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "BackToGameBtn", "Return to GameState2", 250);
...
void PauseState::buttonHit(OgreBites::Button *button)
{
	...
	{
		popAllAndPushAppState(findByName("GameState2"));
		m_bQuit = true;
	}
